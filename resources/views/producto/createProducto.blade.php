        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form action="/producto" method="POST" class="formulario-crear" id="contactForm" enctype="multipart/form-data">
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!-- Nombre input-->
                                <input class="form-control mb-1" id="nombre" name="nombre" type="text" placeholder="Nombre del producto *" value="{{ old('nombre') }}"/>
                            ...
                            <div class="form-group">
                                <!-- Concepto input-->
                                <input class="form-control mb-1" id="concepto" name="concepto" type="text" placeholder="Concepto del producto *" value="{{ old('concepto') }}"/>
                            ...
                            <div class="form-group">
                                <!-- Precio input-->
                                <input class="form-control mb-1" id="precio" name="precio" type="text" placeholder="Precio del producto *" value="{{ old('precio') }}"/>
                    ...
                    <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase mt-5" id="submitButton" type="submit">Crear Producto</button></div>
                </form>
            </div>
        </section>
